...
github_link <- "DAV5300-2025-Fall"
one_minute_paper <- 'https://forms.gle/bEk6KegZ1AMvQHNt5'
one_minute_paper_results <- 'https://docs.google.com/spreadsheets/d/1o-Ra7ZT99mFStJjVoyVBAGp06D9obbzUxcDHvE-w38A/edit?resourcekey=&gid=1573279113#gid=1573279113'
formative_assessment <- 'https://forms.gle/54vyDnT9WtervJ7u7'
formative_assessmnet_results <- 'https://docs.google.com/spreadsheets/d/1LAn9YPFv7UsB2fdgbSEsj0jzROSw_LVuKfBv29R7CcI/edit?resourcekey=&gid=1503929003#gid=1503929003'
course_site <- paste0('https://', tolower(semester), year, '.dav5300.net')
slack_invite <- 'https://join.slack.com/t/dav5300fall2025/shared_invite/zt-3byaerqrp-E6GBxXXOWcpIucF1iIluPA'
slack_link <- 'https://dav5300fall2025.slack.com'
