...
.pull-left[
Please see [fall2025.dav5300.net/assignments/project.html](https://fall2025.dav5300.net/assignments/project.html) for details on the project proposal.

Please sign-up for a time to meet with me (via Zoom) on November 25th to discuss your project. Please have your proposal ready (template on the course website) and come prepared with questions. 


]
.pull-right[
```{r, echo=FALSE, fig.width=5, fig.height=5}
signup_link <- 'https://docs.google.com/spreadsheets/d/1SFWmZmuWP81LQWHvLVQtm3_Eea7TQpbEfAMmb2R4q8I/edit?usp=sharing'
